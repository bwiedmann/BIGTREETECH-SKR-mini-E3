...
#define STRING_CONFIG_H_AUTHOR "(hckcd, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3P SKR 1.2"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -6, -4 } //-1.85
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 7 // 5*5=25, 7*7=49 points
